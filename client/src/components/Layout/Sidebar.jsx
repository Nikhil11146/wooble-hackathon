...
export default function Sidebar({ role = "WORKER", activePath, onNavigate }) {
  ...
  return (
    <aside className="border-r border-[#222d34] bg-[#111b21] p-3 lg:min-h-full lg:p-4">
      <p className="mb-3 px-3 text-[11px] font-bold uppercase tracking-[0.14em] text-[#8696a0]">
        ...
        {links.map(([label, path]) => {
          ...
          return (
            <button
              ...
              className={[
                "min-h-12 shrink-0 cursor-pointer rounded-xl px-3.5 py-2.5 text-left text-[15px] font-medium transition-colors",
